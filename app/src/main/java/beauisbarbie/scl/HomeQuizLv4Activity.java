...
public class HomeQuizLv4Activity extends AppCompatActivity {
    ...
    static final private int QUIZ_COUNT = 11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_quiz_lv4);
    ...
    public void showNextQuiz(){
        countLabel.setText(questionCount+" / 11");
